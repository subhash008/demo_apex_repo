...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899937396472422874)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899937614598422874)
,p_plug_template_id=>wwv_flow_imp.id(108899937396472422874)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899938045562422874)
,p_plug_template_id=>wwv_flow_imp.id(108899937396472422874)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899938581595422874)
,p_plug_template_id=>wwv_flow_imp.id(108899937396472422874)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899938860634422874)
,p_plug_template_id=>wwv_flow_imp.id(108899937396472422874)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899939169613422874)
,p_plug_template_id=>wwv_flow_imp.id(108899937396472422874)
,p_name=>'Sub Regions'
