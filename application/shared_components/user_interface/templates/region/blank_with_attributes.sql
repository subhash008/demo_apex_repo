...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899875698513422847)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899875902700422847)
,p_plug_template_id=>wwv_flow_imp.id(108899875698513422847)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899876289193422847)
,p_plug_template_id=>wwv_flow_imp.id(108899875698513422847)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899876521242422847)
,p_plug_template_id=>wwv_flow_imp.id(108899875698513422847)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899876819251422847)
,p_plug_template_id=>wwv_flow_imp.id(108899875698513422847)
,p_name=>'Sub Regions'
