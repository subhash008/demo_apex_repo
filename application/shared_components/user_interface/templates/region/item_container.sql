...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899934891479422873)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899935164658422873)
,p_plug_template_id=>wwv_flow_imp.id(108899934891479422873)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899935401519422873)
,p_plug_template_id=>wwv_flow_imp.id(108899934891479422873)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899935773474422873)
,p_plug_template_id=>wwv_flow_imp.id(108899934891479422873)
,p_name=>'Button Start'
