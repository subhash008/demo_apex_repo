...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899962486904422884)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899962708782422884)
,p_plug_template_id=>wwv_flow_imp.id(108899962486904422884)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899963061970422884)
,p_plug_template_id=>wwv_flow_imp.id(108899962486904422884)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899963386533422884)
,p_plug_template_id=>wwv_flow_imp.id(108899962486904422884)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899963601684422884)
,p_plug_template_id=>wwv_flow_imp.id(108899962486904422884)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899963985171422885)
,p_plug_template_id=>wwv_flow_imp.id(108899962486904422884)
