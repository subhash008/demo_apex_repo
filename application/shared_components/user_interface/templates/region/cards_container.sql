...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899882779816422850)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899883052327422850)
,p_plug_template_id=>wwv_flow_imp.id(108899882779816422850)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899883323811422850)
,p_plug_template_id=>wwv_flow_imp.id(108899882779816422850)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899883678654422850)
,p_plug_template_id=>wwv_flow_imp.id(108899882779816422850)
,p_name=>'Sub Regions'
