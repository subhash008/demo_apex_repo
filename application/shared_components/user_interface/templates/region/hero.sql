...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899909201368422861)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899909565322422862)
,p_plug_template_id=>wwv_flow_imp.id(108899909201368422861)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899909870326422862)
,p_plug_template_id=>wwv_flow_imp.id(108899909201368422861)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899910118583422862)
,p_plug_template_id=>wwv_flow_imp.id(108899909201368422861)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899910449960422862)
,p_plug_template_id=>wwv_flow_imp.id(108899909201368422861)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899910730031422862)
,p_plug_template_id=>wwv_flow_imp.id(108899909201368422861)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
