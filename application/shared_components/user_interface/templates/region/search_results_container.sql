...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899940142097422875)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899940660888422875)
,p_plug_template_id=>wwv_flow_imp.id(108899940142097422875)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899941122582422875)
,p_plug_template_id=>wwv_flow_imp.id(108899940142097422875)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899941506531422875)
,p_plug_template_id=>wwv_flow_imp.id(108899940142097422875)
,p_name=>'Sub Regions'
