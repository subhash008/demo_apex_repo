...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899912733446422863)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899913050903422863)
,p_plug_template_id=>wwv_flow_imp.id(108899912733446422863)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899913317206422863)
,p_plug_template_id=>wwv_flow_imp.id(108899912733446422863)
,p_name=>'Sub Regions'
