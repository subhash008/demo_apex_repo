...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899954764284422881)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899955081090422881)
,p_plug_template_id=>wwv_flow_imp.id(108899954764284422881)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899955350999422881)
,p_plug_template_id=>wwv_flow_imp.id(108899954764284422881)
,p_name=>'Tabs'
