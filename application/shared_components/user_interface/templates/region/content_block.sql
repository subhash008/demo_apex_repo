...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899904416063422859)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899904782719422859)
,p_plug_template_id=>wwv_flow_imp.id(108899904416063422859)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899905065743422859)
,p_plug_template_id=>wwv_flow_imp.id(108899904416063422859)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899905367524422860)
,p_plug_template_id=>wwv_flow_imp.id(108899904416063422859)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899905621916422860)
,p_plug_template_id=>wwv_flow_imp.id(108899904416063422859)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899905988234422860)
,p_plug_template_id=>wwv_flow_imp.id(108899904416063422859)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899906265888422860)
,p_plug_template_id=>wwv_flow_imp.id(108899904416063422859)
,p_name=>'Sub Regions'
