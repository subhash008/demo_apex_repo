...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899870409255422844)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899870704666422844)
,p_plug_template_id=>wwv_flow_imp.id(108899870409255422844)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899871050655422844)
,p_plug_template_id=>wwv_flow_imp.id(108899870409255422844)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899871352039422845)
,p_plug_template_id=>wwv_flow_imp.id(108899870409255422844)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899871625523422845)
,p_plug_template_id=>wwv_flow_imp.id(108899870409255422844)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899871919616422845)
,p_plug_template_id=>wwv_flow_imp.id(108899870409255422844)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899872274462422845)
,p_plug_template_id=>wwv_flow_imp.id(108899870409255422844)
,p_name=>'Sub Regions'
