...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(108899932769528422871)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899933011447422872)
,p_plug_template_id=>wwv_flow_imp.id(108899932769528422871)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899933307209422872)
,p_plug_template_id=>wwv_flow_imp.id(108899932769528422871)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899933655319422872)
,p_plug_template_id=>wwv_flow_imp.id(108899932769528422871)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899933904464422872)
,p_plug_template_id=>wwv_flow_imp.id(108899932769528422871)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899934225079422872)
,p_plug_template_id=>wwv_flow_imp.id(108899932769528422871)
,p_name=>'Sub Regions'
