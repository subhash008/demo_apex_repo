...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(108899860068865422839)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899860398298422839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899860641808422839)
,p_page_template_id=>wwv_flow_imp.id(108899860068865422839)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899860978571422839)
,p_page_template_id=>wwv_flow_imp.id(108899860068865422839)
