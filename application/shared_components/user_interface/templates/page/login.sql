...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(108899850008102422835)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899850353609422835)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899850649370422835)
,p_page_template_id=>wwv_flow_imp.id(108899850008102422835)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899850958239422835)
,p_page_template_id=>wwv_flow_imp.id(108899850008102422835)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899851266170422835)
,p_page_template_id=>wwv_flow_imp.id(108899850008102422835)
,p_name=>'Body Footer'
