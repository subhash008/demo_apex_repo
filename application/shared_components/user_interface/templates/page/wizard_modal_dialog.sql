...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(108899868999724422843)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899869254423422843)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899869581352422843)
,p_page_template_id=>wwv_flow_imp.id(108899868999724422843)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(108899869855604422843)
,p_page_template_id=>wwv_flow_imp.id(108899868999724422843)
